...
The Foundation's [GitHub Sponsors page](https://github.com/sponsors/TitleChain-Foundation) is active. Live tiers and availability are controlled by that page.
...
The current self-service framework is:
...
- Anonymous and private support is respected.
- Public naming or logo use requires permission.
- Sponsorship records are kept separate from participant and implementation data.
- Public impact reporting uses deliverables and aggregate measures, not private beneficiary information.
- Recognition may be corrected or removed when necessary to protect accuracy, safety, independence, or legal compliance.
